...
@section('isi')
    <div class="" style="width:100%">
        ...
        <form method="post" action="/edit/{{ $user->id }}" class="justify-content-end">
            @method('put')
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="nik" value="{{ old('nik', $user->nik) }}">
                @error('nik')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="tlp" value="{{ old('tlp', $user->tlp) }}">
                @error('tlp')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
